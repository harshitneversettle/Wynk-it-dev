      ...
      <div className="w-screen h-screen bg-black flex flex-col overflow-hidden">
          ...
          <div className="flex gap-8 ">
            <div
              className={`flex items-center gap-2 px-3 py-1 rounded-full border font-mono text-lg 
                border-green-800 border-red-900 
              }`}
            >
              <span
                className={`w-2.5 h-2.5 rounded-full bg-green-500 bg-red-600`}
              />
              disconnected
            </div>
          </div>
        ...
        <div className="flex flex-1 gap-4 p-4 overflow-hidden min-h-0">
          <div className="flex-1 min-w-250  relative rounded-2xl overflow-hidden bg-zinc-950 border border-zinc-900 min-h-0">
            ...
            <div
              className={`absolute transition-all duration-800 ease-in-out rounded-xl overflow-hidden bg-zinc-900 border border-zinc-800  ${"bottom-4 right-4 w-60 h-48"}`}
            >
              <video
                ref={selfviderRef}
                autoPlay
          ...
          <div className="flex flex-col w-50 items-center justify-between gap-3 w-36 shrink-0 pb-100 pt-65 ">
            ...
            <div className="flex flex-col w-full items-center justify-center gap-3">
              ...
              <button className=" w-full flex items-center  gap-2.5 px-3 py-3 rounded-xl bg-zinc-950 border-2 border-red-900 text-zinc-300 text-md font-mono hover:bg-red-950/30 hover:border-red-900/60 hover:text-red-500 transition-all duration-150">
                <LuPhone />
                end chat
              </button>
            </div>
          ...
          <div className="flex flex-1 flex-col gro shrink-0 bg-zinc-950 border border-zinc-900 rounded-2xl overflow-hidden min-h-0">
            ...
            <div className="flex gap-2 p-3 border-t border-zinc-900 bg-black/20 shrink-0">
              ...
              />
              <button className="px-3 py-2 bg-zinc-800 border border-zinc-700 text-zinc-300 rounded-xl hover:bg-zinc-700 hover:text-white transition-all duration-150">
                Send
              </button>
            </div>
          </div>
